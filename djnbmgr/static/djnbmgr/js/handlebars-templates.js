...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "\">\n      <td class=\"djnbmgr-notebook-name djnbmgr-notebook-link\">";
  stack1 = depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "this.name", { hash: {} }); }
  ...
  buffer += escapeExpression(stack1) + "</td>\n      <td class=\"djnbmgr-notebook-actions\">\n        <span class=\"djnbmgr-notebook-vc djnbmgr-notebook-action djnbmgr-button\"\n         >Versions</span> \n        <span class=\"djnbmgr-notebook-copy djnbmgr-notebook-action djnbmgr-button\"\n         >Copy</span> \n        <span class=\"djnbmgr-notebook-delete djnbmgr-notebook-action djnbmgr-button\"\n         >Delete</span> \n      </td>\n    </tr>\n  ";
  return buffer;}
  ...
  buffer += "\n  </tbody>\n</table>\n\n";
  return buffer;});
templates['djnbmgr_history'] = template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  var buffer = "", stack1, stack2, foundHelper, tmp1, self=this, functionType="function", helperMissing=helpers.helperMissing, undef=void 0, escapeExpression=this.escapeExpression;
...
function program1(depth0,data) {
  ...
  buffer += "<div class=\"djnbmgr-notebook-history\">\n  <h3>Archived versions of \"";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
  buffer += escapeExpression(stack1) + "\"</h3>\n  <p class=\"djnbmgr-close djnbmgr-button\">Close</p>\n  <table class=\"djnbmgr-notebook-list\">\n    ";
  foundHelper = helpers.notebooks;
  stack1 = foundHelper || depth0.notebooks;
  stack1 = (stack1 === null || stack1 === undefined || stack1 === false ? stack1 : stack1.objects);
  stack2 = helpers.each;
